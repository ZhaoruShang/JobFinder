...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "555c32cd7bf5a33b6416af2b4822504c86812ccc";

    public List<Set<String>> extract(List<String> articles) {
        ObjectMapper mapper = new ObjectMapper();
        CloseableHttpClient httpClient = HttpClients.createDefault(); // static creation
